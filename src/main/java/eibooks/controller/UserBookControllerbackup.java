...
@WebServlet("*.uapibackup")
public class UserBookControllerbackup extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("/userBookList.uapi")) {
			...
			System.out.println("searchWord-uapi1" + searchWord);
			if(searchWord == null) {
				searchWord = "";
		...
		// 검색 별개로 빼봤음.
			...
			System.out.println("searchWord-uapi" + searchWord);
			if(searchWord == null) {
				searchWord = "";
				map.put("searchWord", searchWord);
			} else {
