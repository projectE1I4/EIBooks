...
<head>
  ...
  <link rel="stylesheet" href="/EIBooks/styles/css/common.css?v=<%= new java.util.Date().getTime() %>">
  <link rel="stylesheet" href="/EIBooks/styles/css/header.css?v=<%= new java.util.Date().getTime() %>">
  <link rel="stylesheet" href="/EIBooks/styles/css/footer.css?v=<%= new java.util.Date().getTime() %>">
  <link rel="stylesheet" href="/EIBooks/styles/css/main.css?v=<%= new java.util.Date().getTime() %>">
  ...
  <script src="/EIBooks/styles/js/ui-common.js?v=<%= new java.util.Date().getTime() %>"></script>